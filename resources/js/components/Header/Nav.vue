                    ...
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_content ml-auto">
                            ...
                            <div class="top_bar_user">
                                ...
                                <div><router-link to="/user/register">Register</router-link></div>
                                <div v-if="!authenticated"><router-link to="/user/login">Sign in</router-link></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="header_search">
                            <div class="header_search_content">
                                <div class="header_search_form_container">
                                    <form class="header_search_form clearfix"> <input type="text" @input="updateProdFromSer(search)" v-model="search" class="header_search_input" placeholder="Search for products...">
                    ...
                    <div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
                        <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                            <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                                <div class="wishlist_icon"><img v-if="wishListItems.length > 0" style="height:30px;width:35px" src="/assets/wishList/red-heart.png"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918681/heart.png"
                                v-if="wishListItems.length == 0"  alt=""></div>
                                <div class="wishlist_content">
                                    <div class="wishlist_text"><a href="#">Wishlist</a></div>
                                    <div class="wishlist_count">{{ wishListItems.length }}</div>
                                </div>
                            </div> <!-- Cart -->
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    <div class="cart_icon"> <img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918704/cart.png" alt="">
                                        <span class="cart_count">{{count_cart}}</span>
                            ...
                            <div class="main_nav_menu">
                                <ul class="standard_dropdown main_nav_dropdown">
                                    <li class="hassubs"> <a href="#">Laptop<i class="fas fa-chevron-down"></i></a>
                                        <ul class="over">
                                            <li class="hassubs"> <a href="#">Lenovo<i class="fas fa-chevron-down"></i></a>
                                                <ul class="over">
                                    ...
                                    <li @click="home" class="hassubs"><router-link to="/"> Home </router-link></li>
                                    <li class="hassubs"> <router-link to="/cart"> Cart </router-link>  </li>
                                </ul>
                            </div> <!-- Menu Trigger -->
                            <div class="main_nav_menu" v-if="authenticated">
                                <ul class="standard_dropdown main_nav_dropdown">
                                 <li class="hassubs"><a href="#">Welcome back : {{ user.name }}<i class="fas fa-chevron-down"></i></a>
                                        <ul style="margin-left: 120px;" class="over">
                                            <li> <a href="#">Account</a>
                                            </li>
                                        </ul>
                                    </li>
                                
                                    <li @click="logout" class="hassubs"><a href="#"> Log out </a></li>
                                </ul>
                            </div>
                            <div class="menu_trigger_container ml-auto">
                                <div class="menu_trigger d-flex flex-row align-items-center justify-content-end">
                                    <div class="menu_burger">
                                        <div class="menu_trigger_text mr-4">menu</div>
...
export default {
     ...
     name: 'Nav',
     computed: {
        ...mapGetters(['count_cart','totalPrice', 'user', 'products', 'wishListItems']),
        authenticated: {
        get () {
     ...
     ,
     methods: {
        ...mapActions(['home' , 'logout', 'updateProdFromSer']) 
     },
     data() {
        return{
            search: '',
